...
<!--<![endif]-->
	<head>
		<meta charset="utf-8">
		<title>Contacto | Joan Pere</title>
	...
	<body class="no-trans">
		...
		<div class="section translucent-bg bg-image-1 blue">
			<div class="container object-non-visible" data-animation-effect="fadeIn">
				<h1 id="services"  class="text-center title">Experiencia</h1>
				<div class="space"></div>
				<div class="row">
					<div class="col-sm-6">
						<div class="media">
			...
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2">
						<h1 class="text-center">Colaboramos?</h1>
					</div>
				</div>
			</div>
		</div>
					...
					<div class="col-md-12">
						...
						<div class="isotope-container row grid-space-20">
							<div class="col-sm-6 col-md-3 isotope-item web-development">
								<div class="image-box">
									<div class="overlay-container">
										<img src="images/smartcampus.png" alt="">
										<a class="overlay" data-toggle="modal" data-target="#project-1">
											<i class="fa fa-search-plus"></i>
											<span>Web development</span>
										</a>
									</div>
									<a class="btn btn-default btn-block" data-toggle="modal" data-target="#project-1">UJI Smart Campus Web</a>
								</div>
								<!-- Modal -->
										...
										<div class="modal-content">
											...
											<div class="modal-body">
												...
												<div class="row">
													...
													<div class="col-md-6">
														<a href="http://smart.uji.es/" target="_blank"><img src="images/smartcampus.png" alt=""></a>
													</div>
												</div>
											</div>
							...
							<div class="col-sm-6 col-md-3 isotope-item app-development">
								<div class="image-box">
									<div class="overlay-container">
										<img src="images/smartcampusapp.png" alt="">
										<a class="overlay" data-toggle="modal" data-target="#project-2">
											<i class="fa fa-search-plus"></i>
											<span>App Development</span>
										</a>
									</div>
									<a class="btn btn-default btn-block" data-toggle="modal" data-target="#project-2">UJI Smart Campus App</a>
								</div>
								<!-- Modal -->
											...
											<div class="modal-body">
												...
												<div class="row">
													<div class="col-md-6">
														...
														<div align=center>
															<a href="https://play.google.com/store/apps/details?id=es.uji.smartuji.base" target="_blank"><img src="images/gplay.png" alt="" width='120' ></a>
														</div>


													</div>
													<div class="col-md-6">
													<iframe width="550" height="310" src="https://www.youtube.com/embed/h9qZLppfQUs" frameborder="0" allowfullscreen></iframe>
							...
							<div class="col-sm-6 col-md-3 isotope-item web-development">
								<div class="image-box">
									<div class="overlay-container">
										<img src="images/Bicicas.png" alt="">
										<a class="overlay" data-toggle="modal" data-target="#project-3">
											<i class="fa fa-search-plus"></i>
											<span>Web development</span>
										</a>
									</div>
									<a class="btn btn-default btn-block" data-toggle="modal" data-target="#project-3">Bicicas-Renfe Trip Planner</a>
								</div>
								<!-- Modal -->
										...
										<div class="modal-content">
											...
											<div class="modal-body">
												...
												<div class="row">
													...
													<div class="col-md-6">
														<img src="images/Bicicas2.png" alt="">
													</div>
												</div>
											</div>
											<div class="modal-footer">
							...
							<div class="col-sm-6 col-md-3 isotope-item app-development">
								<div class="image-box">
									...
									<a class="btn btn-default btn-block" data-toggle="modal" data-target="#project-4">Agile2014 App</a>
								</div>
								<!-- Modal -->
											...
											<div class="modal-body">
												...
												<div class="row">
													<div class="col-md-6">
														...
														<div align=center>
															<a href="https://play.google.com/store/apps/details?id=es.uji.smartuji.agile" target="_blank"><img src="images/gplay.png" alt="" width='120' ></a>
														</div>
													</div>

													<div class="col-md-6">
														<iframe width="420" height="315" src="https://www.youtube.com/embed/YWBzMiW3ocM" frameborder="0" allowfullscreen></iframe>
													</div>
												</div>
											</div>
											<div class="modal-footer">
							...
							<div class="col-sm-6 col-md-3 isotope-item app-development">
								<div class="image-box">
									<div class="overlay-container">
										<img src="images/buscas.png" alt="">
										<a class="overlay" data-toggle="modal" data-target="#project-5">
											<i class="fa fa-search-plus"></i>
											<span>App Development</span>
										</a>
									</div>
									<a class="btn btn-default btn-block" data-toggle="modal" data-target="#project-5">Bus Castellón</a>
								</div>
								<!-- Modal -->
											...
											<div class="modal-body">
												...
												<div class="row">
													<div class="col-md-6">
														...
														<div align=center>
															<a href="https://play.google.com/store/apps/details?id=com.ubik.buscas" target="_blank"><img src="images/gplay.png" alt="" width='120' ></a>
														</div>
													</div>
													<div class="col-md-6">
														<img src="images/buscas.png" alt="">
							...
							<div class="col-sm-6 col-md-3 isotope-item app-development">
								<div class="image-box">
									<div class="overlay-container">
										<img src="images/pnow.png" alt="">
										<a class="overlay" data-toggle="modal" data-target="#project-6">
											<i class="fa fa-search-plus"></i>
											<span>App Development</span>
										</a>
									</div>
									<a class="btn btn-default btn-block" data-toggle="modal" data-target="#project-6">Parking Now</a>
								</div>
								<!-- Modal -->
											...
											<div class="modal-body">
												...
												<div class="row">
													<div class="col-md-6">
														...
														<div align=center>
															<a href="https://play.google.com/store/apps/details?id=es.uji.parkingnow" target="_blank"><img src="images/gplay.png" alt="" width='120' ></a>
														</div>
													</div>
													<div class="col-md-6">
														<img src="images/pnow.png" alt="">
											...
											<div class="modal-body">
												...
												<div class="row">
													<div class="col-md-6">
														...
														<div align=center>
															<a href="https://play.google.com/store/apps/details?id=es.uji.smartuji.esriConference2014" target="_blank"><img src="images/gplay.png" alt="" width='120' ></a>
														</div>
													</div>
													<iframe width="420" height="315" src="https://www.youtube.com/embed/f_BFiIAf-1M" frameborder="0" allowfullscreen></iframe>
												</div>
											</div>
											<div class="modal-footer">
												<button type="button" class="btn btn-sm btn-default" data-dismiss="modal">Close</button>
		...
		<div class="section translucent-bg bg-image-2 pb-clear">
			<div class="container object-non-visible" data-animation-effect="fadeIn">
				<h1 id="clients" class="title text-center">Tecnologías</h1>
				<div class="space"></div>
				<div class="row">
					<div class="col-md-4">
		...
		<footer id="footer">
			...
			<div class="footer section">
				<div class="container">
					<h1 class="title text-center" id="contact">¿En que te puedo ayudar?</h1>
					<div class="space"></div>
					<div class="row">
						<div class="col-sm-6">
